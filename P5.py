...
r = [1.2, -0.8, -0.2, 1.5, -0.3, -0.6, 1.1, 2, 2.5, 0.7, -0.2, 0.1, -1.6, -1.3, -0.4, 0.9, -2, -0.25, 0.5, 0.4, 0.15, -1.5, 3, -0.9, 0.4, 2.2, -1.8, 1.4]
...
shuffle_index = [12, 5, 9, 2, 10, 7, 1, 14, 6, 11, 3, 8, 4, 13]
...
while i in range(iter_num):
    ...
    for j in range(len(shuffle_index)):
        extrinsic_2_interleaved[j] = extrinsic_2[shuffle_index[j] - 1]
